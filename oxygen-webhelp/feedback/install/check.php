...
$okImg = '<span class="oxy-icon oxy-icon-ok success"></span>';

$cfgDir = '../resources/php/config';
    ...
    <div class="panel">
        ...
        <table class="col2">
            ...
            <tr>
                ...
                <td>
                    ...
                    if (!$sspath) {
                        ...
                        if (is_dir($sspath) && is_writable($sspath)) {
            ...
            <tr>
                ...
                <td>
                    <?php echo (stristr($_SERVER['SERVER_SOFTWARE'],
                            'apache') != false) ? '<b>' . $okImg . '</b><span> (' . $_SERVER['SERVER_SOFTWARE'] . ')</span>' : '<b>' . $failedImg . '</b><span>
...
if ($showButton) {
    echo "<div class='text-right'>
	        <button type='submit' name='next' class='btn btn-lg btn-primary'>Start Installation</button>
	</div>";
}
?>